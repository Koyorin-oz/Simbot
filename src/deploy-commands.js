...
(async () => {
  ...
  console.log(
    "[DEPLOY] Acces runtime SimBot : dev/admin -> COMMAND_ADMIN_DEV_ROLE_ID ; moderation + give-away -> COMMAND_MODERATION_ROLE_ID ou COMMAND_MODERATION_ROLE_IDS (virgules) ; bypass proprietaire : COMMAND_OWNER_USER_ID / COMMAND_OWNER_USER_IDS."
  );
  console.log(
