  ...
  const embed = new EmbedBuilder()
    ...
    .setDescription(
      [
        ...
        "**Playlist** : ta liste perso ; les titres venus de Spotify y sont aussi mis avec **🟢 Spotify ·** (meme audio YouTube derriere).",
        "**Playlist Spotify** : enregistre des **playlists publiques** Spotify, puis **Lancer dans le vocal** — affichage Spotify, lecture YouTube.",
